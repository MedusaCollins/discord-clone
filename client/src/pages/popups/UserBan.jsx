...
const UserBan = ({filterMenu, setFilterMenu }) => {
  return (
      ...
      <div className="relative bg-[#313338] rounded-md shadow-md mx-5" onClick={(e) => e.stopPropagation()}>
        <div className="text-center sm:w-96">
            ...
            <div className='justify-between flex p-4 rounded-b-xl bg-black-200'>
              ...
              <button onClick={() => setFilterMenu({...filterMenu, banPopup: false, showPopup: false})} className='text-red-400 hover:underline text-ssm'>Revoke Ban</button>
            </div>
        </div>
      </div>
      </div>
